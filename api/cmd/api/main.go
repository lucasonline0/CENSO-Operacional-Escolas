...
func (app *application) routes() http.Handler {
	...
	mux.Route("/v1", func(r chi.Router) {
		...
		r.Group(func(protected chi.Router) {
			...
			protected.Delete("/admin/dres/{id}", app.AdminDeleteDRE)
			...
			protected.Get("/admin/users/bulk-dre-bootstrap/preview", app.AdminBulkDREBootstrapPreview)
			protected.Post("/admin/users/bulk-dre-bootstrap", app.AdminBulkDREBootstrap)
			...
			protected.Delete("/admin/users/{id}", app.AdminDeleteUser)
