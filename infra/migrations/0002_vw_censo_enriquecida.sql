...
--
-- Idempotência: CREATE OR REPLACE VIEW. O loader em
-- api/cmd/api/main.go (applyMigrations) aplica este arquivo no startup,
-- assim como sua cópia em api/cmd/api/migrations/.
-- =====================================================================
