        ...
        <div className="space-y-6">
            ...
            <div className="p-4 bg-slate-50 border rounded-md grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                ...
                {form.watch("qtd_atende_necessidade_merenda") === "Não" && (
                    <NumberInput control={control} name="quantitativo_necessario_merenda" label="Para atender plenamente à demanda atual da merenda escolar, quantas merendeiras faltam para completar a equipe da cozinha?" />
                )}
            </div>
